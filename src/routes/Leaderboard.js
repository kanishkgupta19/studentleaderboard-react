...
class Leaderboard extends React.Component{
  ...
  sortby(e) {
    ...
    fetch(`https://cors-anywhere.herokuapp.com/https://studentleaderboard-api.herokuapp.com/students-records/view/sortby/${order}${field}`, {crossDomain:true, method:'GET',
      headers: {
